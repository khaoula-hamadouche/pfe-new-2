    ...
    <div class="naVbar"><br>
        ...
        <div class="col">
            ...
            <div class="card card2">
                <h3><a href="afficher.php">Modifier un utilisateur </a></h3>
            
              </div>
              <br>
              <div class="card card3">
                <h3><a href="afficher1.php">Supprimer un utilisateur </a></h3>
              </div>
              <div class="card card4">
                <h3><a href="consulter.php">Consulter les courriers</a> </h3>
              </div>
        </div>
        </div>
    </div>
